    ...
    var mediaValetHootsuite = function () {
        ...
        */
        mediaValetHootsuite.prototype.insertAsset = function (imageurl) {
            ...
            var filenameandext = mediaValetHootsuite.prototype.filenameandext(imageurl);
            var filename = '', extension = '';
            filename = filenameandext.split('.');
            for (var a = filename.length - 1; a >= 0; a--) {
      ...
      */
        ...
        mediaValetHootsuite.prototype.ApplicationInsightsTracking = function (eventname) {
